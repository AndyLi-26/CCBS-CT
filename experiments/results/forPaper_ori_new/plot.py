...
def plotTvSolved(ms,solveIns,markers):
    ...
    for i,d in enumerate(DATAALL):
        ...
        for j,k in enumerate(solveIns):
            ...
            ys.append(y)
            plt.plot(y,x, label=name[j],marker=markers[j],markerfacecolor="None",alpha=0.5)
...
def plotSucc(ms,solveIns,markers):
    ...
    for i,d in enumerate(DATAALL):
        ...
        for j,k in enumerate(solveIns):
            ...
            x,y=getSuccRate(d[k])
            plt.plot(x, y, label=name[j],marker=markers[j])
...
if __name__=="__main__":
    ...
    markers=['.','o','v','^','1','s','*']
    ls=[(),(1, 1),(1, 10), (5, 10), (3, 10, 1, 10), (3, 5, 1, 5), (3, 10, 1, 10, 1, 10)]
